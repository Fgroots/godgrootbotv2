    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_message(
                ...
                text=f"Found {(len_results)} 🔰നിങ്ങൾ ഉദ്ദേശിക്കുന്ന പടം താഴെ കാണുന്ന ലിസ്റ്റിൽ ഉണ്ടേൽ അതിൽ CLICK ചെയ്യുക,അല്ലങ്കിൽ NEXT⏩ CLICK ചെയ്തു,അടുത്ത പേജ് കൂടെ ചെക്ക് ചെയ്യുക

🤖Manavalan (BOT) എന്ന CHAT SCREEN ഓപ്പൺ ആയാൽ,താഴെ ഉള്ള START BUTTON CLICK ചെയ്യുക,സിനിമ ലഭിക്കുന്നത് ആകും❤️.

🗣താഴെ ഉള്ള ലിസ്റ്റിൽ ഇല്ലങ്കിൽ,ആ സിനിമ എവിടെങ്കിലും റിലീസ്(THEATRE/OTT) ആയിട്ട് ഉണ്ടോ എന്ന് ഉറപ്പു വരുത്തീട്ട്,സിനിമയുടെ പേരും വർഷവും ശെരി ആയി കൊടുക്കുക.😊: <code>{query}</code>",
